...
export function EngineeringMethod() {
  ...
  return (
    <section id="method" className="py-24 px-4 sm:px-12 w-full border-t border-white/10">
      <div className="max-w-[95vw] 2xl:max-w-[110rem] mx-auto space-y-12">
        {/* Header */}
          ...
          {principles.map((item, idx) => {
            ...
            return (
              <motion.div
                ...
                className="sticky pro-card rounded-[2rem] p-7 sm:p-10 border border-white/[0.08] bg-[#141416]/95 backdrop-blur-2xl shadow-2xl overflow-hidden group"
              >
